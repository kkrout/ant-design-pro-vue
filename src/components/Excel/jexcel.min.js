...
var jexcel = (function(el, options) {
    ...
    var defaults = {
        ...
        text:{
            ...
            entries: ' entries',
            columnName: '列名',
            insertANewColumnBefore: '向前插入一列',
            insertANewColumnAfter: '向后插入一列',
            deleteSelectedColumns: '删除选择列',
            renameThisColumn: '重命名列',
            orderAscending: '升序',
            orderDescending: '降序',
            insertANewRowBefore: '向前插入一行',
            insertANewRowAfter: '向前插入一行',
            ...
            saveAs: '另存为...',
            about: '关于',
            areYouSureToDeleteTheSelectedRows: '确定要删除选择行?',
            areYouSureToDeleteTheSelectedColumns: '确定要删除选择列?',
    ...
    obj.createCell = function(i, j, value) {
        ...
        // Wrap option
        if (obj.options.wordWrap == true || obj.options.columns[i].wordWrap == true ) {
        ...
        if (obj.records[y][x].classList.contains('readonly') == true && ! force) {
            ...
            if (obj.options.columns[x].editor) {
                ...
                if (obj.options.columns[x].type == 'checkbox' || obj.options.columns[x].type == 'radio') {
                    ...
                    //     obj.records[y][x].style.whiteSpace = 'nowrap';
                    // } else {
        ...
        if (e.target.classList.contains('jexcel_corner')) {
            ...
            if (jexcelTable[1] == 2 && jexcel.current.options.editable == true) {
                ...
                if (element.parentNode) {
                    var x = element.getAttribute('data-x');
                    var y = element.getAttribute('data-y');
                    var excelData = jexcel.current.getData();
                    var curdata = excelData[y];
                    //非表头
                    if (x && y) {
                        jexcel.current.options.ondbclick && jexcel.current.options.ondbclick(curdata,x,y);
                    }else{
                        //表头
                    }
                }
